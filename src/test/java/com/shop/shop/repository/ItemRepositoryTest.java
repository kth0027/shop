...
/*    @PersistenceContext
    ...
    public void findByPriceLessTest() {
        this.createItemList();
    ...
    public void queryDslTest() {
        this.createItemList();
        JpaQueryMethodFactory queryFactory = new JPAQueryFactory(em);
        QItem qItem =
                QItem.item;
        JpaQueryMethodFactory<Item> query = queryFactory.selectFrom(qItem)
